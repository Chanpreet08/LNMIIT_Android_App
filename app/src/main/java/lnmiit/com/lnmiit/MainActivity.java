...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            // Handle the emergency action
        }
        else if (id == R.id.bus)
        {
            // Handle the bus action
        }
        else if (id == R.id.map)
        {
